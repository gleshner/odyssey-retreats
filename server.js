...
const retreats = [
  {
    ...
    season: 'Spring',
    type: 'Camp Retreat',
    title: 'Spring Woodland Retreat',
    dates: 'June 23–29, 2025',
  ...
  },
  {
    ...
    season: 'Fall',
    type: 'Camp Retreat',
    title: 'Autumn Woodland Retreat',
    dates: 'October 2025',
    location: 'Northern Maryland',
    image: 'https://images.unsplash.com/photo-1475688621402-4257c812d6db?auto=format&fit=crop&w=900&q=80',
    colorClass: 'card-fall',
    description: 'The same transformative weekend format surrounded by the warmth and beauty of Maryland\'s autumn foliage. A deeply restorative experience.',
    features: ['Private cabin with full bathroom', 'All meals included', 'Fall foliage setting', 'Hiking & outdoor activities', 'Evening social events'],
    price: 'Full weekend + day passes',
    inclusive: true,
  },
  {
    slug: 'fall-convention',
    season: 'Fall',
    type: 'Hotel Convention',
    title: 'Baltimore Fall Convention',
    dates: 'November 2025',
    ...
    description: 'A larger hotel-based convention at Baltimore\'s Inner Harbor. Broader programming covering interpersonal relationships and community topics.',
    features: ['Inner Harbor hotel setting', 'Expanded workshop programming', 'Community and couples themes', 'Marc train / Uber accessible', 'Day passes available'],
    price: 'Full weekend + day passes',
    inclusive: false,
  },
  {
    ...
    description: 'Close out the year with intention. A reflective and renewing convention at Baltimore\'s Inner Harbor, designed for the season of new beginnings.',
    features: ['Baltimore Inner Harbor hotel', 'Broader relationship themes', 'Special year-end programming', 'Marc train / Uber accessible', 'Day passes available'],
    price: 'Full weekend + day passes',
    inclusive: false,
  },
];
